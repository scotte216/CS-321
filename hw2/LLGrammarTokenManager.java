/* Generated By:JavaCC: Do not edit this line. LLGrammarTokenManager.java */
import java.io.*;

/** Token Manager. */
public class LLGrammarTokenManager implements LLGrammarConstants
{
...
/** Constructor. */
public LLGrammarTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public LLGrammarTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
